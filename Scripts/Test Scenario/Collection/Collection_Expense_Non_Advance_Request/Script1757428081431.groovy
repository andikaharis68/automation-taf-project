...
List<String> sheetNames = ['Credentials', 'Request', 'Approval']

Map scenarioData = [
	"TestDataPath" : "$GlobalVariable.TEST_DATA_LOCATION/Collection_Expense_Non_Advance.xlsx",
...
scenarioData['AdvanceSettlement'] = "N"
