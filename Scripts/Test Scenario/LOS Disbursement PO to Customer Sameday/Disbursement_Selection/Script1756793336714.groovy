...
Map scenarioData = [ScenarioId: GlobalVariable.SCENARIO_ID, TestDataName: 'LOS_Disbursement_PO_to_Customer_Sameday_TestData.xlsx', 'SheetNames': ['Selection', 'MasterData']]
...
WebUI.callTestCase(findTestCase('Test Cases/Test Step/LOS Disbursement PO to Customer/Input_DisbursementSelection'), dataRow, FailureHandling.CONTINUE_ON_FAILURE)
