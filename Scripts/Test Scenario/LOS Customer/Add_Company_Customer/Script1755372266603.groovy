...
KeywordUtil.logInfo("scenarioData : ${scenarioData}")
...
WebUI.callTestCase(findTestCase('Test Cases/Test Step/LOS Customer/Add Company Customer/NavigateTo_CompanyCustomer_MainData'), scenarioData, FailureHandling.CONTINUE_ON_FAILURE)
WebUI.callTestCase(findTestCase('Test Cases/Test Step/LOS Customer/Add Company Customer/Add_CompanyCustomer_Main_Data'), scenarioData, FailureHandling.CONTINUE_ON_FAILURE)