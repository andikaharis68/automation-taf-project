...
String testDataName = "Remedial_Expense_Advance.xlsx"
String scenarioId = GlobalVariable.SCENARIO_ID
Map dataRow = [:]

dataRow += BaseHelper.getTestDataByScenario("RemedialAdvance", GlobalVariable.TEST_DATA_LOCATION + "/" + testDataName, scenarioId)
...
WebUI.callTestCase(findTestCase('Test Cases/Test Step/Remedial Expense/Completion_Data_Remedial_Advance'), dataRow, FailureHandling.CONTINUE_ON_FAILURE)
...
if(!dataRow["statusRemed"]) {
	WebUI.callTestCase(findTestCase('Test Cases/Test Step/Remedial Expense/Remedial_ Inquiry_Get_Approval'), dataRow, FailureHandling.CONTINUE_ON_FAILURE)
}
