...
Map scenarioData = [ScenarioId: GlobalVariable.SCENARIO_ID, TestDataName: 'LOS_Disbursement_PO_to_Customer_NonSameday_TestData.xlsx', 'SheetNames': ['Approval', 'MasterData']]
