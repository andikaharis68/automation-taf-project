...
'Step 1: Navigate to Online Disbursement Inquiry'
menu.navigateToOnlineDisbursementInquiry()

'Step 2: Switch to iframe main page'
menu.switchToIframeMainPage()

'Step 3: Verify Landing in Online disbursement inquiry'
inquiry.verifyLandingInInquiryPage()
