...
'Step 1: Add guarantor personal and save'
guarantor.addGuantorPersonal(GuarantorPersonalName, CustomerRelationshipPersonal)

'Step 2: Add guarantor company'
guarantor.addGuantorCompany(GuarantorCompanyName, CustomerRelationshipCompany)

'Step 3: Click save and continue'
guarantor.clickSaveContinue()

'Step 4: verify landing application data'
