...
'Step 2: verify landing in asset inventory request'
inventoryReq.verifyLandingScreen()

'Step 3: search by agreement no'
inventoryReq.doSearchByAgreementNo(AgreementNo)

'Step 4: click search'
inventoryReq.clickSearch()

'Step 5: click first button pencil'
inventoryReq.clickButtonPencil()