...
'Step 2: Verify landing in send asset to pool page'
sendAsset.verifyLandingScreen()

'Step 3: do search by AgreementNo and collection group'
sendAsset.doSearch(AgreementNo, CollectionGroup)

'Step 4: click Firs Button Pencil'
